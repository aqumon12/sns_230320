...
<div class="d-flex justify-content-center">
	<div class="sign-up-box">
		...
		<form id="signUpForm" method="post" action="/user/edit_profile">
			<table class="sign-up-table table table-bordered">
				...
				<tr>
					<th>* 비밀번호</th>
					<td><input type="password" id="password" name="password" class="form-control" placeholder="새로운 비밀번호를 입력하세요."></td>
				</tr>
				<tr>
					<th>* 비밀번호 확인</th>
			...
			<button type="submit" id="signUpBtn" class="btn btn-primary float-right">수정</button>
